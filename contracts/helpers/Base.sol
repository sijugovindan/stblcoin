...
contract Base {
    ...
    // Amount of IUSD to be locked in gas pool on opening troves
    uint256 constant public IUSD_GAS_COMPENSATION = 200e18;

    // Minimum amount of net IUSD debt a vault must have
